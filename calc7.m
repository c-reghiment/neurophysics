...
%
%The Morris-Lecar barnacle muscle model was developed by Catherine Morris and Harold Lecar.
%The model reproduces the oscillatory behavior in relation to Ca++ and K+ conductance 
%in the giant barnacle muscle fiber. ML model has class I and class II neuron excitability. 
...
%par.P_start = par.P_start.*(1+1e-3.*randn);    
par.P_start = par.P_start.*(1-1e-2);    
...
%V null cline; note that it does not contain the C_m term
