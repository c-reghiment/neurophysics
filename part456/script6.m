...
r4=calc6(param6(-7.5e-6, 1e-3, 15e-3, -7.5e-6));
...
for c=1:length(I), r1{c}=calc6(param6(I(c))); r2{c}=calc6(param6(0,0,0,0,I(c))); end;
figure (3); clf; hold on; for c=1:length(I), plot(r1{c}.t,r1{c}.V_m); end; hold off;
figure (4); clf; hold on; for c=1:length(I), plot(r2{c}.t,r2{c}.V_m); end; hold off;
